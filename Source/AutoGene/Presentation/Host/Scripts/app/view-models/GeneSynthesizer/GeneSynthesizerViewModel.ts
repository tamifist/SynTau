...
class GeneSynthesizerViewModel extends BaseViewModel {
    ...
    public selectedGeneChanged(): void {
        ...
        if (selectedGeneId) {
            ...
            var self = (<any>window).geneSynthesizerViewModel;
    ...
    public updateSynthesisProcess(): void {

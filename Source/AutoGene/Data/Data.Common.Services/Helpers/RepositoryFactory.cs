...
namespace Data.Common.Services.Helpers
{
    /// <summary>
    ...
    /// </remarks>
    public class RepositoryFactory : IRepositoryFactory, IScopedDependency
    {
        /// <summary>
        /// The <see cref="RepositoryFactoriesBuilder"/> with which to create a new repository.
        /// </summary>
        /// <remarks>
        /// Should be initialized by constructor injection
        /// </remarks>
        private readonly RepositoryFactoriesBuilder _repositoryFactoriesBuilder;
        ...
        public RepositoryFactory(RepositoryFactoriesBuilder _repositoryFactoriesBuilder)
        {
            this._repositoryFactoriesBuilder = _repositoryFactoriesBuilder;
        ...
        /// </remarks>
        public IRepository<T> GetRepositoryForEntityType<T>()
            where T : BaseEntity
        {
            return GetRepository<IRepository<T>>(
                _repositoryFactoriesBuilder.GetRepositoryFactoryForEntityType<T>());
        }
        ...
        /// of the injected <see cref="RepositoryFactoriesBuilder"/>.
        /// </param>
        /// <remarks>
